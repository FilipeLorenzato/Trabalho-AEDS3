...
public class RegistroHashBoletoTag implements RegistroHashExtensivel<RegistroHashBoletoTag> {
    private int id;           // Chave primária (ID do registro BoletoTag)
    private long endereco;    // Endereço no arquivo de dados
    private short TAMANHO = 12; // int (4) + long (8) = 12 bytes

    public RegistroHashBoletoTag() {
        this.id = -1;
        this.endereco = -1;
    }

    public RegistroHashBoletoTag(int id, long endereco) {
        this.id = id;
