...
public class RegistroHashTag implements RegistroHashExtensivel<RegistroHashTag> {
    private int id;           // Chave primária (ID da tag)
    private long endereco;    // Endereço no arquivo de dados
    private short TAMANHO = 12; // int (4) + long (8) = 12 bytes

    public RegistroHashTag() {
        this.id = -1;
        this.endereco = -1;
    }

    public RegistroHashTag(int id, long endereco) {
        this.id = id;
