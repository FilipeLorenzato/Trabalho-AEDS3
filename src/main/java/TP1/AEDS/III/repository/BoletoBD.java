...
public class BoletoBD<TipoGenerico extends Registro> {
    ...
    public BoletoBD(String nomeArquivo, Constructor<TipoGenerico> construtor) throws Exception {
    ...
    public int create(TipoGenerico obj) throws Exception {
        arquivo.seek(0);
